package com.projet.product.productapp.config;
...
@EnableJpaRepositories(basePackages = {"com.projet.product.productapp"})
...
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        em.setPackagesToScan("com.projet.product.productapp.entities");
